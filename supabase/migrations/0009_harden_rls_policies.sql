...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'high_schools') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'amenities') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'utilities') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'discussion_categories') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'badges') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'academic_programs') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'hygiene_categories') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'utility_types') THEN
    ALTER TABLE utility_types ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "utility_types_select" ON utility_types;
CREATE POLICY "utility_types_select" ON utility_types FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "utility_types_insert" ON utility_types;
CREATE POLICY "utility_types_insert" ON utility_types FOR INSERT TO authenticated WITH CHECK (false);
DROP POLICY IF EXISTS "utility_types_update" ON utility_types;
CREATE POLICY "utility_types_update" ON utility_types FOR UPDATE TO authenticated USING (false);
DROP POLICY IF EXISTS "utility_types_delete" ON utility_types;
CREATE POLICY "utility_types_delete" ON utility_types FOR DELETE TO authenticated USING (false);
...
CREATE POLICY "neighborhood_landmarks_update" ON neighborhood_landmarks FOR UPDATE TO authenticated USING (false);
...
CREATE POLICY "neighborhood_campus_distances_update" ON neighborhood_campus_distances FOR UPDATE TO authenticated USING (false);
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'student_preferences') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'student_lifecycle_history') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'business_reviews') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'business_review_replies') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'contact_methods') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'identity_documents') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'reputation_events') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'verification_records') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'verification_evidence') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'property_review_flags') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_preferences') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_profiles') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_interactions') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_messages') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'friend_preferences') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'friend_profiles') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'friend_interactions') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'community_likes') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'property_review_votes') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'discussion_votes') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'business_review_votes') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_matches') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'friend_matches') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'friend_connections') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'roommate_conversations') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'business_media') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forums') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_topics') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_posts') THEN
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_subscriptions') THEN
    ALTER TABLE forum_subscriptions ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_subscriptions_select" ON forum_subscriptions;
...
CREATE POLICY "forum_subscriptions_insert" ON forum_subscriptions FOR INSERT TO authenticated WITH CHECK (false);
DROP POLICY IF EXISTS "forum_subscriptions_update" ON forum_subscriptions;
CREATE POLICY "forum_subscriptions_update" ON forum_subscriptions FOR UPDATE TO authenticated USING (false) WITH CHECK (false);
DROP POLICY IF EXISTS "forum_subscriptions_delete" ON forum_subscriptions;
CREATE POLICY "forum_subscriptions_delete" ON forum_subscriptions FOR DELETE TO authenticated USING (false);

  END IF;
END $$;
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_memberships') THEN
    ALTER TABLE forum_memberships ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_memberships_select" ON forum_memberships;
CREATE POLICY "forum_memberships_select" ON forum_memberships FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "forum_memberships_insert" ON forum_memberships;
CREATE POLICY "forum_memberships_insert" ON forum_memberships FOR INSERT TO authenticated WITH CHECK (false);
DROP POLICY IF EXISTS "forum_memberships_update" ON forum_memberships;
CREATE POLICY "forum_memberships_update" ON forum_memberships FOR UPDATE TO authenticated USING (false) WITH CHECK (false);
DROP POLICY IF EXISTS "forum_memberships_delete" ON forum_memberships;
CREATE POLICY "forum_memberships_delete" ON forum_memberships FOR DELETE TO authenticated USING (false);
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forums') THEN
    ALTER TABLE forums ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forums_select_anon" ON forums;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_topics') THEN
    ALTER TABLE forum_topics ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_topics_select_anon" ON forum_topics;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_posts') THEN
    ALTER TABLE forum_posts ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_posts_select_anon" ON forum_posts;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_subscriptions') THEN
    ALTER TABLE forum_subscriptions ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_subscriptions_select_anon" ON forum_subscriptions;
CREATE POLICY "forum_subscriptions_select_anon" ON forum_subscriptions FOR SELECT TO anon USING (true);
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'forum_memberships') THEN
    ALTER TABLE forum_memberships ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "forum_memberships_select_anon" ON forum_memberships;
CREATE POLICY "forum_memberships_select_anon" ON forum_memberships FOR SELECT TO anon USING (true);
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'utility_incidents') THEN
    ALTER TABLE utility_incidents ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "utility_incidents_select_anon" ON utility_incidents;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'hygiene_reports') THEN
    ALTER TABLE hygiene_reports ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "hygiene_reports_select_anon" ON hygiene_reports;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'neighborhood_reviews') THEN
    ALTER TABLE neighborhood_reviews ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "neighborhood_reviews_select_anon" ON neighborhood_reviews;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'hygiene_categories') THEN
    ALTER TABLE hygiene_categories ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "hygiene_categories_select_anon" ON hygiene_categories;
...
BEGIN
  IF EXISTS (SELECT 1 FROM pg_tables WHERE tablename = 'utility_types') THEN
    ALTER TABLE utility_types ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "utility_types_select_anon" ON utility_types;
