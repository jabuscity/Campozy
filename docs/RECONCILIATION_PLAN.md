...
| 4.5 | `lifecycle-service.ts` | `lib/services/lifecycle-service.ts` | Role transitions, alumni progression |
...
| # | Action | File | Notes |
|---|--------|------|-------|
| 6.1 | Add missing nav items | `components/navbar.tsx` | `/universities`, `/campuses`, `/neighborhoods`, `/businesses`, `/founders`, `/alumni` |
...
```
Home | Housing | Campuses | Universities | Neighborhoods | Community | Opportunities | Businesses | Founders | Alumni | Resources | About | Profile
```
