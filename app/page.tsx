      ...
      <footer className="w-full bg-white border-t border-neutral-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-start gap-8">
          <div className="max-w-xs">
            ...
            <p className="text-sm text-neutral-500 leading-relaxed">
              The Student Trust Network for East Africa. Providing reliable data
              for students to thrive in their academic journey across Kenya.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-neutral-100 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
