...
export default async function CampusDiscussionsPage({ params }: { params: { id: string } }) {
  const discussions = await CommunityService.getDiscussions({ campusId: params.id, limit: 20 })
