...
export async function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-neutral-200 bg-gradient-to-r from-blue-50 via-white to-blue-50 backdrop-blur-md overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06] bg-[url('/patterns/beadmosaic.png')] bg-center mix-blend-multiply grayscale bg-[length:550px] lg:bg-[length:480px]" />
