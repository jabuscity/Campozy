  ...
  const showMobileFooter = pathname === '/' || pathname === '/about'
   return (
     <footer className="bg-neutral-900 text-white pt-12 pb-12 lg:pb-6 overflow-hidden relative">
       ...
       <div className="hidden xl:block absolute left-0 top-0 bottom-0 w-[calc((100vw-1280px)/2)] opacity-[0.18] bg-blue-200/30 bg-[url('/patterns/beadmosaic.png')] bg-center mix-blend-screen grayscale bg-[length:240px]" />
